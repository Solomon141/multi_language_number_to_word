function getEthiopicDate(intGCDay, intGCMonth, intGCYear) {
    let intDayDiff = 0;
    let intPagumen = 0;
    let intECDay = 0;
    let intECMonth = 0;
...
function getDateDifference(intGCMonth, intGCYear) {
    ...
    switch (intGCMonth) {
        ...
        case 10:
            ...
            break;
        case 9:
            intDayDiff = isLeapYear(intGCYear + 1) ? 11 : 10;
            break;
    }
    return intDayDiff;
}
...
const ethiopicDate = getEthiopicDate(27, 12, 2023);
console.log(ethiopicDate);